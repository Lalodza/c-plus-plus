...
void calcSuma(int, int, int[][COL],int [][COL], int[][COL]);
void calcResta(int, int, int[][COL],int [][COL], int[][COL]);
...
main ()
{
    ...
    getch();
    system("cls");
    calcSuma(f,c,a1,a2,a3);
	calcResta(f,c,a1,a2,a4);    
	getch();
}
...
void calcSuma(int f, int c, int a1[FIL][COL], int a2 [FIL][COL],int a3[FIL][COL])
{
    int i,j;
    cout<<endl<<"\t\tElementos de la Matriz Suma:"<<endl;
    for(i=0; i<f; i++)
    {
        for(j=0; j<c; j++)
        {
...
void calcResta(int f, int c, int a1[FIL][COL], int a2 [FIL][COL],int a3[FIL][COL])
{
    int i,j;
    cout<<endl<<"\t\tElementos de la Matriz Resta:"<<endl;
    for(i=0; i<f; i++)
    {
        for(j=0; j<c; j++)
        {
